...
import { Users, Briefcase, Shield, MapPin, DollarSign, Calendar, Clock, CheckCircle, Star, Wallet, Search, Menu, X, ChevronRight, Award, Bell, ArrowLeft, Send, MessageSquare, Upload, Home, Sparkles, Truck, Trees, Wrench, ShoppingCart, Package, Eye, EyeOff, BadgeCheck, ShieldCheck, Car, Navigation, Camera, AlertCircle, Zap, TrendingUp, Target, ThumbsUp, MapPinned, RotateCcw, Mail, ArrowRight, User, CreditCard, Building, Banknote, Lock, ArrowDownToLine, AlertTriangle, FileText, Scale, Gavel, MessageCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-5 gap-6">
            {[
              {icon: Package, title: 'Package Pick Ups', gradient: 'from-cyan-500 to-blue-600', shadow: 'shadow-cyan-500/30'},
              {icon: RotateCcw, title: 'Store Returns', gradient: 'from-purple-500 to-pink-600', shadow: 'shadow-purple-500/30'},
              {icon: Mail, title: 'Mailing Packages', gradient: 'from-orange-500 to-red-600', shadow: 'shadow-orange-500/30'},
              {icon: Truck, title: 'Deliveries', gradient: 'from-green-500 to-emerald-600', shadow: 'shadow-green-500/30'},
              {icon: Clock, title: 'Queueing', gradient: 'from-yellow-500 to-orange-600', shadow: 'shadow-yellow-500/30'}
            ].map((c, i) => (
