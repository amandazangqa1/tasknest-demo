  ...
  const LandingView = () => (
    <UniversalBackground>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-10 border border-white/20 mb-12 text-left"><h2 className="text-3xl font-bold text-white mb-6 text-center">About TaskNest</h2><p className="text-lg text-white/90">TaskNest is a South African-born mobile and web platform that connects everyday people with trusted local “taskers” who can run errands and complete small jobs. From deliveries and grocery pickups to queueing and household tasks, TaskNest simplifies daily life while creating income opportunities for unemployed youth and informal workers.</p></div>
        <div className="grid grid-cols-2 gap-8 mb-20">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-left"><h3 className="text-2xl font-bold text-cyan-400 mb-4">Our Mission</h3><p className="text-white/90">To empower communities by bridging the gap between time-strapped users and capable taskers promoting convenience, trust, and inclusive economic growth in underserved townships.</p></div>
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-left"><h3 className="text-2xl font-bold text-cyan-400 mb-4">Our Vision</h3><p className="text-white/90">A future where digital platforms unlock opportunities in every corner of South Africa, enabling people to earn, connect, and thrive through community-driven services.</p></div>
        </div>
