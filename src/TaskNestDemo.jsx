...
export default function TaskNestDemo() {
  ...
  const availableTasks = [
    ...
    { id: 5, title: 'Assemble a wardrobe', category: 'Assembly', budget: 'R400', location: 'Centurion, Pretoria', deadline: 'This weekend', description: 'Need help assembling a PAX wardrobe system. All parts and tools available.', requester: 'Mike T.', postedTime: '30 minutes ago' },
